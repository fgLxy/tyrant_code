...
public class ExcelUtils {
	...
	public static <T> String generateExcel2007(Class<T> clazz, String path, String title, ExcelDataSource<T> dataSource) {
	...
	public static <T> String generateExcel2003(Class<T> clazz,String path, String title, ExcelDataSource<T> dataSource) {
		List<ExcelHeader> headers = generateHeaders(clazz);
		ExcelHelper<T> excelHelper = new ExcelHelper<>(headers, dataSource, 1000);
